...
* Correction No : D30K927050                                           *
* Description   : HeaderX table is passed to BAPI 'BAPI_CONTRACT_CREATE'
*                 to fix Ariba Materials contract issue.               *
*----------------------------------------------------------------------*

FUNCTION zmm_contract_create_ug .
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  TABLES
