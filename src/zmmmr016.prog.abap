REPORT ZMMMR016 NO STANDARD PAGE HEADING LINE-SIZE 132 LINE-COUNT 65.
************************************************************************
*    Program     :  ZMMMR016  - SERVICE ITEM: BY MATERIAL NUMBER
...
WRITE: /1 TEXT-RPT, SY-REPID COLOR COL_GROUP INVERSE ON,
       45 TEXT-002, 105 TEXT-DTE, SY-DATUM, TEXT-AMP, SY-UZEIT.
WRITE: / TEXT-CLT UNDER TEXT-RPT, SY-MANDT UNDER SY-REPID,
         TEXT-012 UNDER TEXT-002, TEXT-PGE UNDER TEXT-DTE,
         SY-PAGNO UNDER SY-DATUM.
WRITE: /.
ULINE.
FORMAT COLOR COL_NORMAL.

WRITE: /1 TEXT-003, 30 TEXT-006, 60 TEXT-007, 90 TEXT-009.
WRITE: / TEXT-004 UNDER TEXT-003, TEXT-008 UNDER TEXT-007,
...
*This routine will process all the records in the TABLE1 for output.
LOOP AT TABLE1.
    CLEAR:   TABLE2, TABLE4.
...
FORM OUTPUT.
WRITE: /.
WRITE: / TABLE4-MATNR UNDER TEXT-003, TABLE4-FIELD2 UNDER TEXT-006,
         TABLE4-FIELD3 UNDER TEXT-007.
IF TABLE4-FIELD4 NE 'N/A'.                                      "#235
   WRITE: TABLE4-FIELD4 UNDER TEXT-009.
ENDIF.
*write: /1 table4-matnr, 40 table4-field2, 90 table4-field3.
*write: 120 table4-field4.
