*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMMMV_T001W
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMMMV_T001W         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMMMV_T001W'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMMMV_T001W_EXTRACT
TOTAL = ZMMMV_T001W_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMMMV_T001W'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMMMV_T001W-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMMMV_T001W_EXTRACT
TOTAL = ZMMMV_T001W_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMMMV_T001W-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMMMV_T001W'
...
TOTAL = ZMMMV_T001W_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMMMV_T001W-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMMMV_T001W-UPD_FLAG NE SPACE.
