REPORT ZMMMR014 NO STANDARD PAGE HEADING LINE-SIZE 170 LINE-COUNT 58.
************************************************************************
*    Program     :  ZMMMR014  - METER & REGULATOR CATALOG 2: BY KEYWORD
...
* 97/08/05 md7140 increase font size
************************************************************************
...
IF HEADER1 = 'Y'.                             "md7140 reformat of header
   ...
   WRITE:  /1 TEXT-005,  35 TEXT-007, 65 TEXT-009, 96 TEXT-010,
          118 TEXT-018, 144 TEXT-003.
   WRITE: / TEXT-008 UNDER TEXT-007,
            TEXT-008 UNDER TEXT-009,
            TEXT-006 UNDER TEXT-010,
            TEXT-011 UNDER TEXT-018,
...
IF HEADER2 = 'Y'.
   WRITE: / TEXT-RPT, SY-REPID COLOR COL_NEGATIVE, 65 TEXT-013,
        150 TEXT-DTE, SY-DATUM, TEXT-AMP, SY-UZEIT.
   WRITE: / TEXT-CLT UNDER TEXT-RPT, SY-MANDT UNDER SY-REPID,
        TEXT-012 UNDER TEXT-002,
        TEXT-PGE UNDER TEXT-DTE, SY-PAGNO UNDER SY-DATUM.
   ULINE.
...
*                write: /151 table2-field5.
                 WRITE: / TABLE2-FIELD5 UNDER TEXT-018.
...
*write: /40 table4-field2, 70 table4-field3.
*write: 120 table4-field4, 151 table4-field5, 210 table4-field6+12(6).
WRITE: / TABLE4-FIELD2 UNDER TEXT-007,
*        table4-field3 under text-009,          "#235
         TABLE4-FIELD4 UNDER TEXT-010,
         TABLE4-FIELD5 UNDER TEXT-018,
