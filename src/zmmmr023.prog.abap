REPORT ZMMMR023 NO STANDARD PAGE HEADING LINE-SIZE 170 LINE-COUNT 58.
************************************************************************
*    Program     :  ZMMMR023  - GENERAL SUPPLIES: BY MANUFACTURER PART #
...
* 97/08/22 md7140 increase font size DRMM0165
************************************************************************
*THIS INCLUDE WILL BRING IN THE DATA DEFINITIONS COMMON IN MOST CATALOGS
INCLUDE ZNMMM001 .

DATA  : BEGIN OF TEMPTABLE2 OCCURS 100000.
...
WRITE: /1 TEXT-010,  32 TEXT-006, 63 TEXT-007,
       93 TEXT-009, 125 TEXT-003.
...
SORT TEMPTABLE2 BY SORT2 ASCENDING
                   MATNR ASCENDING.

LOOP AT TEMPTABLE2.
MOVE TEMPTABLE2-MATNR  TO TEMPTABLE-MATNR.
APPEND TEMPTABLE.
CLEAR  TEMPTABLE.
ENDLOOP.
...
*THIS ROUTINE WILL FIND ALL RECORDS WITH RECORDS THAT HAVE A
...
LOOP AT TEMPTABLE2.
MOVE TEMPTABLE2-MATNR  TO TEMPTABLE-MATNR.
MOVE TEMPTABLE2-SORT1  TO TEMPTABLE-SORT1.
APPEND TEMPTABLE.
CLEAR  TEMPTABLE.
ENDLOOP.
        ...
        PERFORM LASTLINE USING FIELD2-LINE.
           ...
           PERFORM LASTLINE USING FIELD3-LINE.
              ...
              PERFORM LASTLINE USING FIELD4-LINE.
                 ...
                 WRITE: / TABLE2-FIELD6+12(6) UNDER TEXT-003.
...
ENDIF.
*rite: /1 table4-field1, 40 table4-field2, 100 table4-field3.
*rite: 130 table4-field4, 200 table4-field6+12(6).
...
IF CHECKPOINT6 EQ 'Y'.
   IF TABLE3-ATINN EQ KEYW_ATINN.
      ...
      MOVE TABLE3-ATWRT   TO  TEMPTABLE2-SORT2.
      APPEND TEMPTABLE2.
      CLEAR TEMPTABLE2.
   ENDIF.
ENDIF.
