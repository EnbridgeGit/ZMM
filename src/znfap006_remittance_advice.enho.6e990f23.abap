"Name: \PR:RFFOAVIS_FPAYM\FO:HR_REMITTANCE_ACKNOWLEDGE_RFC\SE:BEGIN\EI
ENHANCEMENT 0 ZNFAP006_REMITTANCE_ADVICE.

*----------------------------------------------------------------------*
* Version No    :  01                                                  *
* Date          : 07-03-2013                                           *
* Modified By   : Babumiya Mohammad                                    *
* Correction No : D30K922075                                           *
...
* Correction No : D30K922829                                           *
* Description   : Comment the code in the enhancement as a custom report
*                 ZARBREM is created for Payment remittance advice.    *
*----------------------------------------------------------------------*
