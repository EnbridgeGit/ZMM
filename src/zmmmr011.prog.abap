REPORT ZMMMR011 NO STANDARD PAGE HEADING LINE-SIZE 170 LINE-COUNT 58.
************************************************************************
*    Program     :  ZMMMR011  - METER & REGULATOR CATALOG: BY MANU. NAME
...
* 97/03/31 md7140 increase font size by reducing white space
************************************************************************
...
IF HEADER1 = 'Y'.                             "md7140 reformat of header
   ...
   WRITE: /1 TEXT-010, 18 TEXT-005, 49 TEXT-006, 75 TEXT-007,
         105 TEXT-009, 140 TEXT-003.
...
WRITE: /.
*write: /1 table4-field1, 18 table4-field2, 49 table4-field3.
*write: 75 table4-field4, 105 table4-field5, 140 table4-field6+12(6).
