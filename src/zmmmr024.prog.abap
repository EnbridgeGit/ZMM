REPORT ZMMMR024 NO STANDARD PAGE HEADING LINE-SIZE 170 LINE-COUNT 58.
************************************************************************
*    Program     :  ZMMMR024  - GENERAL SUPPLIES: BY KEYWORD, PRIMARY DS
...
************************************************************************
* 97/10/16 md7140 #235 Eliminate printing of N/A in secondary descrip
************************************************************************
...
FORM OUTPUT.
   ON CHANGE OF TEMPTABLE-CLASS.
       ...
       WRITE: /.
       WRITE: /1 TEXT-014, 12 REP_SUBCLASS.
       ULINE: /.
       WRITE: /.
   ENDON.
...
*         table4-field3 under text-009,                          "#235
...
ENDIF.
*rite: /70 table4-field2.
*rite: 100 table4-field3, 150 table4-field4, 210 table4-field6+12(6).
...
*-----------------------------------------------------------------------
FORM BUILDTEMPTABLE.
   PERFORM CLASSCLINT USING 'AUTOMOTIVE'.
   PERFORM CLASSCLINT USING 'ELECTRICAL'.
   PERFORM CLASSCLINT USING 'FASTENERS'.
   PERFORM CLASSCLINT USING 'INSTR_GAUGE_TESTER'.
   PERFORM CLASSCLINT USING 'OTH_OFFICE_SUPPLY'.
   PERFORM CLASSCLINT USING 'OTHER_GEN_SUPPLIES'.
   PERFORM CLASSCLINT USING 'PUMPS'.
   PERFORM CLASSCLINT USING 'SAFETY_AND_APPAREL'.
   PERFORM CLASSCLINT USING 'STATIONERY'.
   PERFORM CLASSCLINT USING 'STOPPER_AND_TAPPNG'.
   PERFORM CLASSCLINT USING 'TOOLS'.
ENDFORM.
