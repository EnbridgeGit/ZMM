REPORT ZMMMR022 NO STANDARD PAGE HEADING LINE-SIZE 170 LINE-COUNT 58.
************************************************************************
*    Program     :  ZMMMR022  - MM: GENERAL SUPPLIES: BY MATERIAL NUMBER
...
WRITE: /1 TEXT-003, 20 TEXT-006, 51 TEXT-007,
       81 TEXT-009, 111 TEXT-010.
...
*This routine will process all the records in TABLE1 for output.
LOOP AT TABLE1.
    CLEAR:   TABLE2, TABLE4.
...
FORM OUTPUT.
WRITE: /.
WRITE: / TABLE4-MATNR+12(6) UNDER TEXT-003,
